...
// File paths
constexpr char KOREADER_FILE_BIN[] = DUET_STATE_ROOT_PATH "/koreader.bin";
constexpr char KOREADER_FILE_JSON[] = DUET_STATE_ROOT_PATH "/koreader.json";
constexpr char KOREADER_FILE_BAK[] = DUET_STATE_ROOT_PATH "/koreader.bin.bak";
...
bool KOReaderCredentialStore::loadFromFile() {
  // Try JSON first
  if (Storage.existsForRead(KOREADER_FILE_JSON)) {
  ...
  if (Storage.existsForRead(KOREADER_FILE_BIN)) {
