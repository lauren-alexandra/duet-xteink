...
class SdCardFont {
 public:
  ...
  // Returns true when the selected style was generated from the regular face
  // with a synthetic bold and/or slant effect. Older v4 files report false.
  bool isSyntheticStyle(uint8_t style) const;
