...
struct ReaderLayoutSettingsSnapshot {
  ...
  bool operator==(const ReaderLayoutSettingsSnapshot& other) const {
    return fontFamily == other.fontFamily && fontSize == other.fontSize &&
           ...
           sdFontPointSize == other.sdFontPointSize &&
...
EpubReaderMenuActivity::EpubReaderMenuActivity(
    ...
    const bool initialSettingsChanged)
    : Activity("EpubReaderMenu", renderer, mappedInput),
      ...
      settingsChanged(initialSettingsChanged) {}
...
EpubReaderMenuActivity::TabMenuItems EpubReaderMenuActivity::buildMenuItems(bool hasFootnotes, bool hasBookmarks,
  ...
  mainItems.push_back({MenuAction::BOOK_INFO, StrId::STR_MORE_INFO});
  mainItems.push_back(
  ...
  bookmarkItems.push_back({MenuAction::LOOK_UP_WORD, StrId::STR_DICTIONARY});
  bookmarkItems.push_back({MenuAction::LOOKUP_HISTORY, StrId::STR_LOOKUP_HISTORY});
