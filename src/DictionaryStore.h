...
class DictionaryStore {
 ...
 private:
  ...
  static constexpr const char* CONFIG_PATH = DUET_STATE_ROOT_PATH "/dictionary_config.json";
  static constexpr const char* HISTORY_PATH = DUET_STATE_ROOT_PATH "/dictionary_history.txt";
