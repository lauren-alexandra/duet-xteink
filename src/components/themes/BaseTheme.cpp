...
void BaseTheme::drawRecentBookCover(GfxRenderer& renderer, Rect rect, const std::vector<RecentBook>& recentBooks,
                                    ...
                                    const char* /*currentChapterTitle*/, uint32_t /*currentBookWordCount*/) const {
...
void BaseTheme::drawStatusBar(GfxRenderer& renderer, const float bookProgress, const int currentPage,
                              ...
                              const int stablePageCount, const bool showProgress,
                              const char* progressTextOverride) const {
  ...
  if (showProgress &&
    ...
    if (progressTextOverride && progressTextOverride[0] != '\0') {
      snprintf(progressStr, sizeof(progressStr), "%s", progressTextOverride);
