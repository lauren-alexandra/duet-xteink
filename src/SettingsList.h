...
inline SettingInfo buildLineSpacingPresetSetting() {
  return SettingInfo::DynamicEnum(
      StrId::STR_LINE_SPACING_PRESET, {StrId::STR_TIGHT, StrId::STR_NORMAL, StrId::STR_WIDE},
      []() {
        if (SETTINGS.lineHeightPercent <= 95) return static_cast<uint8_t>(0);
        if (SETTINGS.lineHeightPercent >= 110) return static_cast<uint8_t>(2);
        return static_cast<uint8_t>(1);
      },
      [](const uint8_t preset) {
        constexpr uint8_t values[] = {90, 100, 120};
        SETTINGS.lineHeightPercent = values[std::min<size_t>(preset, std::size(values) - 1)];
      },
...
inline SettingInfo buildSdFontSizeSetting(const SdCardFontFamilyInfo& family) {
  ...
  s.valueGetter = []() { return SETTINGS.fontSize; };
  s.valueSetter = [sizes](uint8_t index) {
    if (sizes.empty()) return;
    if (index >= sizes.size()) index = static_cast<uint8_t>(sizes.size() - 1);
    SETTINGS.fontSize = index;
    SETTINGS.sdFontPointSize = sizes[index];
  };
  return s;
}
  ...
  s.valueSetter = [sdFamilyNames, sdFamilySizes](uint8_t v) {
    ...
    if (SETTINGS.sdFontFamilyName[0] != '\0') {
      if (SETTINGS.sdFontPointSize != 0) {
        targetPointSize = SETTINGS.sdFontPointSize;
      } else {
    ...
    if (v < CrossPointSettings::BUILTIN_FONT_COUNT) {
      ...
      if (sdIdx < static_cast<int>(sdFamilyNames.size())) {
        ...
        SETTINGS.sdFontPointSize = sdFamilySizes[sdIdx].empty() ? 0 : sdFamilySizes[sdIdx][SETTINGS.fontSize];
...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    ...
    add(SettingInfo::Enum(StrId::STR_SLEEP_CYCLE_POWER_CLICKS, &CrossPointSettings::sleepScreenCyclePowerClicks,
                          {StrId::STR_STATE_OFF, StrId::STR_ONE_CLICK, StrId::STR_TWO_CLICKS, StrId::STR_THREE_CLICKS},
                          "sleepScreenCyclePowerClicks", StrId::STR_CAT_DISPLAY));
    ...
    add(SettingInfo::Enum(StrId::STR_HIDE_BATTERY, &CrossPointSettings::hideBatteryPercentage,
                          ...
                          StrId::STR_CAT_DISPLAY));
    {
      // Dashboard Home stat picker: same catalog for every slot. Option order
      // must match CrossPointSettings::HOME_STAT numbering exactly.
      const std::vector<StrId> homeStatOptions = {StrId::STR_HOME_STAT_NONE,
                                                  StrId::STR_HOME_STAT_BOOK_TIME,
                                                  StrId::STR_TIME_LEFT,
                                                  StrId::STR_STATS_PROGRESS_LBL,
                                                  StrId::STR_STATS_DAILY_AVG_LBL,
                                                  StrId::STR_STATS_PAGES_PER_MIN,
                                                  StrId::STR_STATS_SESSIONS_LBL,
                                                  StrId::STR_STATS_AVG_SESSION_LBL,
                                                  StrId::STR_HOME_STAT_DAYS_READING,
                                                  StrId::STR_STATS_EST_FINISH_DATE,
                                                  StrId::STR_HOME_STAT_STREAK,
                                                  StrId::STR_HOME_STAT_READER_TYPE,
                                                  StrId::STR_HOME_STAT_TOTAL_TIME_DEVICE,
                                                  StrId::STR_HOME_STAT_TOTAL_TIME_ALL,
                                                  StrId::STR_HOME_STAT_BOOKS_DEVICE,
                                                  StrId::STR_HOME_STAT_BOOKS_ALL,
                                                  StrId::STR_HOME_STAT_TODAY_TIME,
                                                  StrId::STR_HOME_STAT_TOTAL_SESSIONS};
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_1, &CrossPointSettings::homeStatSlot1, homeStatOptions,
                            "homeStatSlot1", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_2, &CrossPointSettings::homeStatSlot2, homeStatOptions,
                            "homeStatSlot2", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_3, &CrossPointSettings::homeStatSlot3, homeStatOptions,
                            "homeStatSlot3", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_4, &CrossPointSettings::homeStatSlot4, homeStatOptions,
                            "homeStatSlot4", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_5, &CrossPointSettings::homeStatSlot5, homeStatOptions,
                            "homeStatSlot5", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_6, &CrossPointSettings::homeStatSlot6, homeStatOptions,
                            "homeStatSlot6", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_SLOT_7, &CrossPointSettings::homeStatSlot7, homeStatOptions,
                            "homeStatSlot7", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_FOOTER_LEFT, &CrossPointSettings::homeFooterLeft, homeStatOptions,
                            "homeFooterLeft", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_FOOTER_RIGHT, &CrossPointSettings::homeFooterRight, homeStatOptions,
                            "homeFooterRight", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_STRIP_1, &CrossPointSettings::homeStrip1, homeStatOptions,
                            "homeStrip1", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_STRIP_2, &CrossPointSettings::homeStrip2, homeStatOptions,
                            "homeStrip2", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_STRIP_3, &CrossPointSettings::homeStrip3, homeStatOptions,
                            "homeStrip3", StrId::STR_CAT_DISPLAY));
      add(SettingInfo::Enum(StrId::STR_HOME_STAT_STRIP_4, &CrossPointSettings::homeStrip4, homeStatOptions,
                            "homeStrip4", StrId::STR_CAT_DISPLAY));
    }
    ...
    add(SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                          {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_MINIMAL, StrId::STR_THEME_DASHBOARD,
                           StrId::STR_THEME_READING_HOME, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED,
            ...
            .withEnumRawValues({CrossPointSettings::UI_THEME::CLASSIC, CrossPointSettings::UI_THEME::MINIMAL,
                                CrossPointSettings::UI_THEME::DASHBOARD, CrossPointSettings::UI_THEME::READING_HOME,
    ...
    add(buildLineSpacingPresetSetting());
    ...
    add(SettingInfo::Enum(StrId::STR_TEXT_DARKNESS, &CrossPointSettings::textDarkness,
                          ...
                          StrId::STR_CAT_READER));
    add(SettingInfo::Enum(StrId::STR_READER_REFRESH_MODE, &CrossPointSettings::readerRefreshMode,
    ...
    add(SettingInfo::Enum(StrId::STR_BIONIC_READING, &CrossPointSettings::bionicReadingEnabled,
                          {StrId::STR_STATE_OFF, StrId::STR_BIONIC_NORMAL, StrId::STR_BIONIC_SUBTLE},
                          "bionicReadingEnabled", StrId::STR_CAT_READER)
            .withEnumRawValues({BionicReadingMode::Off, BionicReadingMode::Normal, BionicReadingMode::Subtle}));
    ...
    add(SettingInfo::Enum(StrId::STR_DOUBLE_PWR_BTN, &CrossPointSettings::doublePwrBtn,
                          {StrId::STR_IGNORE,
                           StrId::STR_SLEEP,
                           StrId::STR_PAGE_TURN,
                           StrId::STR_TOGGLE_BOOKMARK,
            ...
            .withEnumRawValues({CrossPointSettings::IGNORE,
                                ...
                                CrossPointSettings::FILE_BROWSER,
                                CrossPointSettings::CREATE_CLIPPING}));
    add(SettingInfo::Enum(StrId::STR_TRIPLE_PWR_BTN, &CrossPointSettings::triplePwrBtn,
                          {StrId::STR_IGNORE,
                           StrId::STR_SLEEP,
                           StrId::STR_PAGE_TURN,
                           StrId::STR_TOGGLE_BOOKMARK,
                           ...
                           StrId::STR_BROWSE_FILES,
                           StrId::STR_SAVE_CLIPPING},
                          "triplePwrBtn", StrId::STR_CAT_CONTROLS)
            .withEnumRawValues({CrossPointSettings::IGNORE,
                                CrossPointSettings::SLEEP,
                                CrossPointSettings::PAGE_TURN,
                                CrossPointSettings::TOGGLE_BOOKMARK,
    ...
    add(SettingInfo::Enum(StrId::STR_FILE_BROWSER_DISPLAY, &CrossPointSettings::fileBrowserDisplay,
                          {StrId::STR_FILE_BROWSER_DISPLAY_1_LINE, StrId::STR_FILE_BROWSER_DISPLAY_2_LINES,
                           StrId::STR_FILE_BROWSER_DISPLAY_COVERS, StrId::STR_FILE_BROWSER_DISPLAY_CAROUSEL},
                          "fileBrowserDisplay", StrId::STR_CAT_SYSTEM));
    add(SettingInfo::Enum(
        StrId::STR_FILE_BROWSER_GRID_LAYOUT, &CrossPointSettings::fileBrowserGridLayout,
        {StrId::STR_FILE_BROWSER_GRID_2X2, StrId::STR_FILE_BROWSER_GRID_3X3, StrId::STR_FILE_BROWSER_GRID_4X4},
        "fileBrowserGridLayout", StrId::STR_CAT_SYSTEM));
    add(SettingInfo::Enum(StrId::STR_FILE_BROWSER_SORT, &CrossPointSettings::fileBrowserSort,
                          {StrId::STR_FILE_BROWSER_SORT_AUTHOR, StrId::STR_FILE_BROWSER_SORT_TITLE}, "fileBrowserSort",
                          StrId::STR_CAT_SYSTEM));
    ...
    add(SettingInfo::Value(StrId::STR_DAILY_READING_GOAL, &CrossPointSettings::readingGoalMinutes,
                           {CrossPointSettings::MIN_READING_GOAL_MINUTES, CrossPointSettings::MAX_READING_GOAL_MINUTES,
                            CrossPointSettings::READING_GOAL_STEP_MINUTES},
                           "readingGoalMinutes", StrId::STR_CAT_SYSTEM));
    add(SettingInfo::Toggle(StrId::STR_SHOW_STATS_AFTER_READING, &CrossPointSettings::showStatsAfterReading,
                            "showStatsAfterReading", StrId::STR_CAT_SYSTEM));
    add(SettingInfo::Toggle(StrId::STR_ACHIEVEMENT_POPUPS, &CrossPointSettings::achievementPopups, "achievementPopups",
                            StrId::STR_CAT_SYSTEM));
    ...
    if (halTiltSensor.isAvailable()) {
      for (auto& setting : v) {
        if (setting.nameId == StrId::STR_SHORT_PWR_BTN || setting.nameId == StrId::STR_DOUBLE_PWR_BTN ||
            setting.nameId == StrId::STR_TRIPLE_PWR_BTN || setting.nameId == StrId::STR_LONG_PRESS_ACTION ||
...
inline std::vector<SettingInfo> buildGroupedReaderSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  addReaderSetting(StrId::STR_LINE_SPACING_PRESET);
...
inline std::vector<SettingInfo> buildReaderSettingsParentList(const std::vector<SettingInfo>& allSettings) {
  ...
  addSettingByName(readerSettings, allSettings, StrId::STR_READER_REFRESH_MODE);
...
inline std::vector<SettingInfo> buildReaderFontSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  addSettingByName(settings, allSettings, StrId::STR_TEXT_DARKNESS);
  return settings;
}
...
inline std::vector<SettingInfo> buildReaderPageLayoutSettingsList(const std::vector<SettingInfo>& allSettings) {
  std::vector<SettingInfo> settings;
  settings.reserve(8);
  addSettingByName(settings, allSettings, StrId::STR_LINE_SPACING_PRESET);
...
inline std::vector<SettingInfo> buildControlsPowerSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  addSettingByName(settings, allSettings, StrId::STR_DOUBLE_PWR_BTN);
  addSettingByName(settings, allSettings, StrId::STR_TRIPLE_PWR_BTN);
  addSettingByName(settings, allSettings, StrId::STR_LONG_PRESS_ACTION);
  if (SETTINGS.shortPwrBtn == CrossPointSettings::SHORT_PWRBTN::FOOTNOTES ||
      SETTINGS.doublePwrBtn == CrossPointSettings::SHORT_PWRBTN::FOOTNOTES ||
      SETTINGS.triplePwrBtn == CrossPointSettings::SHORT_PWRBTN::FOOTNOTES ||
...
inline std::vector<SettingInfo> buildGroupedDisplaySettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  displaySettings.push_back(SettingInfo::Submenu(StrId::STR_HOME_STATS, SettingAction::DisplayHomeStats));
  ...
  displaySettings.push_back(SettingInfo::Action(StrId::STR_CUSTOMIZE_HOME_APPS, SettingAction::CustomizeLauncher));
...
inline std::vector<SettingInfo> buildDisplayHomeStatsSettingsList(const std::vector<SettingInfo>& allSettings) {
  std::vector<SettingInfo> statSettings;
  statSettings.reserve(13);

  auto addStatSetting = [&](const StrId nameId) {
    const auto it = std::find_if(allSettings.begin(), allSettings.end(),
                                 [nameId](const auto& setting) { return setting.nameId == nameId; });
    if (it != allSettings.end()) statSettings.push_back(*it);
  };

  const auto theme = static_cast<CrossPointSettings::UI_THEME>(SETTINGS.uiTheme);
  if (theme == CrossPointSettings::UI_THEME::READING_HOME) {
    const StrId readingHomeIds[] = {
        StrId::STR_HOME_STAT_SLOT_1,  StrId::STR_HOME_STAT_SLOT_2,  StrId::STR_HOME_STAT_SLOT_3,
        StrId::STR_HOME_STAT_SLOT_4,  StrId::STR_HOME_STAT_SLOT_5,  StrId::STR_HOME_STAT_SLOT_6,
        StrId::STR_HOME_STAT_STRIP_1, StrId::STR_HOME_STAT_STRIP_2, StrId::STR_HOME_STAT_STRIP_3,
        StrId::STR_HOME_STAT_STRIP_4,
    };
    for (const StrId nameId : readingHomeIds) addStatSetting(nameId);
    return statSettings;
  }

  if (theme == CrossPointSettings::UI_THEME::MINIMAL) {
    addStatSetting(StrId::STR_HOME_STAT_FOOTER_LEFT);
    addStatSetting(StrId::STR_HOME_STAT_FOOTER_RIGHT);
    return statSettings;
  }

  const StrId dashboardIds[] = {
      StrId::STR_HOME_STAT_SLOT_1, StrId::STR_HOME_STAT_SLOT_2,      StrId::STR_HOME_STAT_SLOT_3,
      StrId::STR_HOME_STAT_SLOT_4, StrId::STR_HOME_STAT_SLOT_5,      StrId::STR_HOME_STAT_SLOT_6,
      StrId::STR_HOME_STAT_SLOT_7, StrId::STR_HOME_STAT_FOOTER_LEFT, StrId::STR_HOME_STAT_FOOTER_RIGHT,
  };
  for (const StrId nameId : dashboardIds) addStatSetting(nameId);
  return statSettings;
}
...
inline std::vector<SettingInfo> buildDisplaySleepSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  addSleepSetting(StrId::STR_SLEEP_CYCLE_POWER_CLICKS, StrId::STR_SLEEP_CYCLE_POWER_CLICKS);
...
inline std::vector<SettingInfo> buildSystemFilesCacheSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  addSettingByName(settings, allSettings, StrId::STR_FILE_BROWSER_GRID_LAYOUT);
  addSettingByName(settings, allSettings, StrId::STR_FILE_BROWSER_SORT);
  ...
  settings.push_back(SettingInfo::Action(StrId::STR_PURGE_ORPHAN_CACHES, SettingAction::PurgeOrphanCaches));
...
inline std::vector<SettingInfo> buildSystemReadingStatsSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  if (!halClock.isAvailable()) {
    settings.push_back(SettingInfo::Action(StrId::STR_STATS_DATE, SettingAction::StatsDate));
  }
  settings.push_back(SettingInfo::Submenu(StrId::STR_ALL_TIME_STATS, SettingAction::SystemGlobalStats));
  addSettingByName(settings, allSettings, StrId::STR_DAILY_READING_GOAL);
  addSettingByName(settings, allSettings, StrId::STR_SHOW_STATS_AFTER_READING);
  addSettingByName(settings, allSettings, StrId::STR_IDLE_TIME_THRESHOLD);
  addSettingByName(settings, allSettings, StrId::STR_ACHIEVEMENT_POPUPS);
  return settings;
}
...
inline std::vector<SettingInfo> buildSystemGlobalStatsSettingsList(const std::vector<SettingInfo>& allSettings) {
  ...
  settings.push_back(SettingInfo::Action(StrId::STR_EXPORT_ALL_READING_STATS, SettingAction::BackupStats));
  settings.push_back(SettingInfo::Action(StrId::STR_RESTORE_READING_STATS, SettingAction::RestoreStats));
