...
// File paths
constexpr char WIFI_FILE_BIN[] = DUET_STATE_ROOT_PATH "/wifi.bin";
constexpr char WIFI_FILE_JSON[] = DUET_STATE_ROOT_PATH "/wifi.json";
constexpr char WIFI_FILE_BAK[] = DUET_STATE_ROOT_PATH "/wifi.bin.bak";
...
bool WifiCredentialStore::loadFromFile() {
  // Try JSON first
  if (Storage.existsForRead(WIFI_FILE_JSON)) {
  ...
  if (Storage.existsForRead(WIFI_FILE_BIN)) {
