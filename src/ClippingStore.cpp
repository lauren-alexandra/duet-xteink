...
constexpr char CLIPPINGS_DIR[] = DUET_STATE_ROOT_PATH "/clippings";
...
bool ClippingStore::migrateForFilePath(const std::string& oldFilePath, const std::string& newFilePath,
  ...
  if (!Storage.existsForRead(oldStorePath)) {
    return true;
  }
