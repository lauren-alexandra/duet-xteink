...
- [CrossInk Fonts](https://github.com/uxjulia/crossink-fonts) supplies the current 24-family compatibility catalog used by Alpha.8's on-device downloader.
