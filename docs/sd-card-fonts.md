...
[Download all 123 font families](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.9/Duet-Open-Font-Pack-v1.zip){: .btn .btn-primary }
...
The in-device downloader reads the standard 24-family catalog generated by Duet's checked-in `lib/EpdFont/scripts/sd-fonts.yaml`, using CrossInk's existing compatibility endpoint. The catalog contains:
