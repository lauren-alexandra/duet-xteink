...
1. Download font files from the [crosspoint-fonts repository](https://github.com/crosspoint-reader/crosspoint-fonts)
...
The current list of pre-built fonts is maintained in the [upstream CrossInk fonts repository](https://github.com/uxjulia/crossink-fonts). During the Duet alpha, device-initiated downloads use that credited compatibility service. Duet will not publish to the upstream repository or bucket; its own reviewed font pack and hosting will be introduced separately.
