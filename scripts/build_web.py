"""Build the Duet web portal: compose pages from shared templates/assets,
...
PAGES = {
    "home":     ("HomePageHtml",     "Duet",                   "home",     ""),
    "files":    ("FilesPageHtml",    "Files - Duet",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("SettingsPageHtml", "Settings - Duet Reader", "settings", ""),
    "fonts":    ("FontsPageHtml",    "Fonts - Duet",           "fonts",    ""),
}
