...
PAGES = {
    "home":     ("/",         "Duet",                   "home",     ""),
    "files":    ("/files",    "Files - Duet",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("/settings", "Settings - Duet Reader", "settings", ""),
    "fonts":    ("/fonts",    "Fonts - Duet",           "fonts",    ""),
}
...
if __name__ == "__main__":
    ...
    print(f"Duet web preview: http://localhost:{port}  (Ctrl+C to stop)")
    try:
        httpd.serve_forever()
