...
The current tester release is **Duet v0.1.0-alpha.8**:

- [Download the X3 firmware BIN](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.8/Duet-X3-v0.1.0-alpha.8.bin)
- [Download the X4 firmware BIN](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.8/Duet-X4-v0.1.0-alpha.8.bin)
- [Download the complete firmware ZIP](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.8/Duet-v0.1.0-alpha.8-firmware.zip)
- [Download the complete 123-family Duet font pack](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.8/Duet-Open-Font-Pack-v1.zip)
- [Download the ready-to-copy WordNet 3.0 dictionary pack](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.8/Duet-WordNet-3.0-StarDict.zip)
- [Download SHA-256 checksums](https://github.com/lauren-alexandra/duet-xteink/releases/download/v0.1.0-alpha.8/SHA256SUMS.txt)
- [Read the alpha.8 release page](https://github.com/lauren-alexandra/duet-xteink/releases/tag/v0.1.0-alpha.8)
...
- **Testing and reporting:** [Alpha Testing](docs/ALPHA_TESTING.md), the ordered [Alpha.8 Acceptance Quickstart](docs/ALPHA8_ACCEPTANCE_QUICKSTART.md), and the repository's report forms.
...
2. Download the correct BIN for your device (`Duet-X3-v0.1.0-alpha.8.bin` or `Duet-X4-v0.1.0-alpha.8.bin`).
