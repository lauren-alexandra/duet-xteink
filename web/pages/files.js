...
if (currentPath !== "/") {
  ...
  if (leaf) document.title = leaf + " - Files - Duet Reader";
}
...
function exportLogToFile(filename = null, isBatch = false) {
  ...
  let logText = `Duet Reader ${crosspointVersion} - EPUB Conversion Log\n`;
